...
import { Header, Form, Grid, TextArea, Button, Container } from "semantic-ui-react";
...
export default function JobForm() {
    return (
        <Container id="add-job-container">
...
// <Container id="job-form-container">
//     <Grid id="job-formGrid" rows={4}>
//     <Form id="create-jobForm">
//         <Grid.Row id="job-form-row">
