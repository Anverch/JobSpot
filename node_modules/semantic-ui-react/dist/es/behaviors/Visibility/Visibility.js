...
var Visibility = /*#__PURE__*/function (_Component) {
  ...
  var _super = _createSuper(Visibility);
  ...
  function Visibility() {
    ...
    _defineProperty(_assertThisInitialized(_this), "update", function () {
      ...
      _invoke(_this.props, 'onUpdate', null, _objectSpread(_objectSpread({}, _this.props), {}, {
  ...
  _createClass(Visibility, [{
    ...
    value: function execute(callback, name) {
      ...
      callback(null, _objectSpread(_objectSpread({}, this.props), {}, {
