...
export function createShorthand(Component, mapValueToProps, val) {
  ...
  var valIsReactElement = /*#__PURE__*/isValidElement(val);
  ...
  overrideProps = _isFunction(overrideProps) ? overrideProps(_objectSpread(_objectSpread({}, defaultProps), usersProps)) : overrideProps; // Merge props

  /* eslint-disable react/prop-types */

  var props = _objectSpread(_objectSpread(_objectSpread({}, defaultProps), usersProps), overrideProps); // Merge className
  ...
  if (defaultProps.style || overrideProps.style || usersProps.style) {
    props.style = _objectSpread(_objectSpread(_objectSpread({}, defaultProps.style), usersProps.style), overrideProps.style);
  } // ----------------------------------------
  // Get key
  // ----------------------------------------
  ...
  if (valIsReactElement) return /*#__PURE__*/cloneElement(val, props); // Create ReactElements from built up props

  if (valIsPrimitiveValue || valIsPropsObject) return /*#__PURE__*/React.createElement(Component, props); // Call functions with args similar to createElement()
