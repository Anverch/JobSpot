...
var ModernAutoControlledComponent = /*#__PURE__*/function (_React$Component) {
  ...
  var _super = _createSuper(ModernAutoControlledComponent);
  ...
  function ModernAutoControlledComponent() {
    ...
    _this.state = _objectSpread(_objectSpread(_objectSpread({}, state), initialAutoControlledState), {}, {
  ...
  _createClass(ModernAutoControlledComponent, null, [{
    ...
    value: function getDerivedStateFromProps(props, state) {
      ...
      if (getAutoControlledStateFromProps) {
        var computedState = getAutoControlledStateFromProps(props, _objectSpread(_objectSpread({}, state), newStateFromProps), state); // We should follow the idea of getDerivedStateFromProps() and return only modified state

        return _objectSpread(_objectSpread({}, newStateFromProps), computedState);
      }
