...
var overrideSearchInputProps = function overrideSearchInputProps(predefinedProps) {
  ...
  if ((0, _isUndefined2.default)(input)) {
    return (0, _objectSpread2.default)((0, _objectSpread2.default)({}, predefinedProps), {}, {
      input: {
        className: 'prompt'
      }
    });
  ...
  if ((0, _isPlainObject2.default)(input)) {
    return (0, _objectSpread2.default)((0, _objectSpread2.default)({}, predefinedProps), {}, {
      input: (0, _objectSpread2.default)((0, _objectSpread2.default)({}, input), {}, {
        className: (0, _classnames.default)(input.className, 'prompt')
      })
    });
  }
...
var Search = /*#__PURE__*/function (_Component) {
  ...
  function Search() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "handleResultSelect", function (e, result) {
      (0, _invoke2.default)(_this.props, 'onResultSelect', e, (0, _objectSpread2.default)((0, _objectSpread2.default)({}, _this.props), {}, {
        result: result
      }));
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "handleSelectionChange", function (e) {
      ...
      (0, _invoke2.default)(_this.props, 'onSelectionChange', e, (0, _objectSpread2.default)((0, _objectSpread2.default)({}, _this.props), {}, {
        result: result
      }));
    });
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "renderSearchInput", function (rest) {
      ...
      return _Input.default.create(input, {
        ...
        defaultProps: (0, _objectSpread2.default)((0, _objectSpread2.default)({}, rest), {}, {
          autoComplete: 'off',
          icon: icon,
