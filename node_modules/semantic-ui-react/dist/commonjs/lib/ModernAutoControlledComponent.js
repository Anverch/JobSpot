...
var ModernAutoControlledComponent = /*#__PURE__*/function (_React$Component) {
  ...
  var _super = (0, _createSuper2.default)(ModernAutoControlledComponent);
  ...
  function ModernAutoControlledComponent() {
    ...
    _this.state = (0, _objectSpread2.default)((0, _objectSpread2.default)((0, _objectSpread2.default)({}, state), initialAutoControlledState), {}, {
  ...
  (0, _createClass2.default)(ModernAutoControlledComponent, null, [{
    ...
    value: function getDerivedStateFromProps(props, state) {
      ...
      if (getAutoControlledStateFromProps) {
        var computedState = getAutoControlledStateFromProps(props, (0, _objectSpread2.default)((0, _objectSpread2.default)({}, state), newStateFromProps), state); // We should follow the idea of getDerivedStateFromProps() and return only modified state

        return (0, _objectSpread2.default)((0, _objectSpread2.default)({}, newStateFromProps), computedState);
      }
