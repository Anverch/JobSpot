...
function createShorthand(Component, mapValueToProps, val) {
  ...
  var valIsReactElement = /*#__PURE__*/(0, _react.isValidElement)(val);
  ...
  overrideProps = (0, _isFunction2.default)(overrideProps) ? overrideProps((0, _objectSpread2.default)((0, _objectSpread2.default)({}, defaultProps), usersProps)) : overrideProps; // Merge props

  /* eslint-disable react/prop-types */

  var props = (0, _objectSpread2.default)((0, _objectSpread2.default)((0, _objectSpread2.default)({}, defaultProps), usersProps), overrideProps); // Merge className
  ...
  if (defaultProps.style || overrideProps.style || usersProps.style) {
    props.style = (0, _objectSpread2.default)((0, _objectSpread2.default)((0, _objectSpread2.default)({}, defaultProps.style), usersProps.style), overrideProps.style);
  } // ----------------------------------------
  // Get key
  // ----------------------------------------
  ...
  if (valIsReactElement) return /*#__PURE__*/(0, _react.cloneElement)(val, props); // Create ReactElements from built up props

  if (valIsPrimitiveValue || valIsPropsObject) return /*#__PURE__*/_react.default.createElement(Component, props); // Call functions with args similar to createElement()
